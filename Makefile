...
NAME				=	cub3d
FILES				=	add_texture display_frame display_minimap game hooks img_fill main movement timeval raycast raycast_dda raycast_init parsing parsing_identify parsing_identify_map parsing_utils t_img t_mlx t_player
