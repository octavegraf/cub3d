...
bonus			: CFLAGS += -DBONUS
NAME				=	cub3d
FILES				=	display_frame display_minimap game hooks img_fill main movement raycast raycast_dda raycast_init parsing parsing_identify textures_list parsing_utils t_img t_mlx t_player
...
bonus				:	$(OBJ_BONUS)  $(FT_PRINTF) $(MLX) $(GNL)
